...
class BuildCollectionWithdrawalScreen extends StatelessWidget {
  const BuildCollectionWithdrawalScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return buildScaffold(
        withDrawer: false,
        title: "Collection withdrawal Request",
        body: Column(
          children: [
            buildTwoItemBalanceCard(
                titleOne: "Collection balance",
            ...
            buildSectionContainer(
              child: buildFormInstructionText(
                  text:
                      "Kindly fill the details below to request collection withdrawal to your E-wallet"),
            ),
            buildSectionContainer(
              child: Column(
                children: [
